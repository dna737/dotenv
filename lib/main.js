...
export const configDotenv = DotenvModule.configDotenv;
export const _configVault = DotenvModule._configVault;
export const _parseVault = DotenvModule._parseVault;
export const config = DotenvModule.config;
export const decrypt = DotenvModule.decrypt;
export const parse = DotenvModule.parse;
export const populate = DotenvModule.populate;
