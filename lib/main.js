...
function _dotenvKey(options) {
  ...
  if (import.meta.env.DOTENV_KEY && import.meta.env.DOTENV_KEY.length > 0) {
    return import.meta.env.DOTENV_KEY;
  }
...
function _configVault(options) {
  ...
  let processEnv = import.meta.env;
...
// Populates import.meta.env from .env file
...
// Populate import.meta.env with parsed values
...
// Assuming DotenvModule is imported appropriately

// Exporting individual functions
export let configDotenv = DotenvModule.configDotenv;
export let _configVault = DotenvModule._configVault;
export let _parseVault = DotenvModule._parseVault;
export let config = DotenvModule.config;
export let decrypt = DotenvModule.decrypt;
export let parse = DotenvModule.parse;
export let populate = DotenvModule.populate;
